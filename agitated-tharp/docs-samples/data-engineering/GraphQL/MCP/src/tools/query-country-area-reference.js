...
export const parameters = z.object({
  ...
  filter: z.object({
    ISO3: z.any().optional().describe('ISO3 國家代碼篩選 例: { eq: "USA" } 或 { in: ["USA","JPN"] }'),
    COUNTRY_COMM_ZH: z.any().optional().describe('國家中文名稱篩選 例: { contains: "韓" }'),
    COUNTRY_COMM_EN: z.any().optional().describe('國家英文名稱篩選 例: { contains: "Korea" }'),
    AREA_ID: z.any().optional().describe('地區代碼篩選'),
    AREA_NM: z.any().optional().describe('地區名稱篩選 例: { eq: "亞洲" }'),
    ROW: z.any().optional().describe('排序序號篩選（數值篩選）'),
